...
class ModelRunner:
    ...
    def sample(
        ...
        self._preprocess_logits(
            logits_output, forward_batch.sampling_info, forward_batch.current_generation_step
        )
        ...
        if (
            ...
            forward_batch.needs_additional_steps, forward_batch.unfinished_sequences = (
